...
namespace CoordinatesAoi {
    public class Startup {
        ...
        public void ConfigureServices(IServiceCollection services) {
            ...
            services.AddScoped<CoordinatesCalculatorService, CoordinatesCalculatorService>();
            services.AddScoped<CoordinatesManager, CoordinatesManager>();
        }
